 ...
 * @author Shai Almog
 */
public class GoodGPSStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "GoodGPS";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new GoodGPSStub());
    }
